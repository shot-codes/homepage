...
class Matrix3 {
  ...
  determinant() {
    ...
    const a = te[0],
      ...
      i = te[8];
    return (
      a * e * i - a * f * h - b * d * i + b * f * g2 + c * d * h - c * e * g2
    );
  }
  invert() {
    const te = this.elements,
...
class Color {
  ...
  getStyle(colorSpace = SRGBColorSpace) {
    ...
    return `rgb(${(_rgb$1.r * 255) | 0},${(_rgb$1.g * 255) | 0},${
      (_rgb$1.b * 255) | 0
    })`;
  }
  offsetHSL(h, s, l) {
...
class Composite {
  ...
  setValue(array, offset) {
    ...
    for (
      let i = this._targetGroup.nCachedObjects_, n2 = bindings.length;
      i !== n2;
      ++i
    ) {
...
const useEventRaycast = (ctx, rootCtx, renderCtx) => {
  ...
  let pointer;
  const unsubscribePointer = ctx.pointer.subscribe(
    (value) => (pointer = value)
  );
...
function getFirstIntersection(rootCtx, pointer, camera) {
  ...
  if (
    intersects.length === 0 ||
    !rootCtx.interactiveObjects.has(intersects[0].object)
  )
    return null;
  return intersects[0];
}
...
const useFrameloopRaycast = (ctx, rootCtx) => {
  ...
  const raycast = () => {
    ...
    if (!intersection) {
      ...
      if (!rootCtx.lastIntersection) {
        getThrelteUserData(intersection.object).eventDispatcher?.(
          "pointerenter",
          intersection
        );
      } else if (
  ...
  const audioCtx = {
    ...
    addAudioListener: (listener, id) => {
      ...
      if (audioCtx.audioListeners.has(id)) {
        console.warn(
          `An AudioListener with the id "${id}" has already been added, aborting.`
        );
        return;
      }
  ...
  const ctx = {
    ...
    invalidate: (debugFrameloopMessage) => {
      ...
      if (renderCtx.debugFrameloop && debugFrameloopMessage) {
        renderCtx.invalidations[debugFrameloopMessage] = renderCtx
          .invalidations[debugFrameloopMessage]
...
const useParentSize = () => {
  ...
  const unsubscribeParentSize = parentSizeStore.subscribe(
    (s) => (parentSize = s)
  );
  ...
  const proxy = () => {
    ...
    if (
      clientWidth !== currentParentSize.width ||
      clientHeight !== currentParentSize.height
    ) {
      parentSizeStore.set({
        width: clientWidth,
        height: clientHeight,
...
const Canvas = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_derivedSize = subscribe(
    derivedSize,
    (value) => ($derivedSize = value)
  );
  const { flat: flatStore, linear: linearStore, dpr: dprStore } = rootCtx;
  $$unsubscribe_flatStore = subscribe(
    flatStore,
    (value) => ($flatStore = value)
  );
  $$unsubscribe_linearStore = subscribe(
    linearStore,
    (value) => ($linearStore = value)
  );
  ...
  if (
    $$props.frameloop === void 0 &&
    $$bindings.frameloop &&
    frameloop !== void 0
  )
    $$bindings.frameloop(frameloop);
  if (
    $$props.debugFrameloop === void 0 &&
    $$bindings.debugFrameloop &&
    debugFrameloop !== void 0
  )
    $$bindings.debugFrameloop(debugFrameloop);
  if ($$props.shadows === void 0 && $$bindings.shadows && shadows !== void 0)
    $$bindings.shadows(shadows);
  if (
    $$props.shadowMapType === void 0 &&
    $$bindings.shadowMapType &&
    shadowMapType !== void 0
  )
...
const TransformableObject = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $objectStore, $$unsubscribe_objectStore;
...
const ViewportAwareObject = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    if ($$props.object === void 0 && $$bindings.object && object !== void 0)
      $$bindings.object(object);
    if (
      $$props.viewportAware === void 0 &&
      $$bindings.viewportAware &&
      viewportAware !== void 0
    )
      $$bindings.viewportAware(viewportAware);
    if (
      $$props.inViewport === void 0 &&
      $$bindings.inViewport &&
      inViewport !== void 0
    )
...
const Object3DInstance = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { object } = $$props;
    let { position = void 0 } = $$props;
    let { scale = void 0 } = $$props;
    ...
    if (
      ...
      $$bindings.inViewport(inViewport);
    if (
      $$props.castShadow === void 0 &&
      $$bindings.castShadow &&
      castShadow !== void 0
    )
      $$bindings.castShadow(castShadow);
    if (
      $$props.receiveShadow === void 0 &&
      $$bindings.receiveShadow &&
      receiveShadow !== void 0
    )
      $$bindings.receiveShadow(receiveShadow);
    if (
      $$props.frustumCulled === void 0 &&
      $$bindings.frustumCulled &&
      frustumCulled !== void 0
    )
      $$bindings.frustumCulled(frustumCulled);
    if (
      $$props.renderOrder === void 0 &&
      $$bindings.renderOrder &&
      renderOrder !== void 0
    )
...
const OrbitControls2 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    if (
      $$props.dampingFactor === void 0 &&
      $$bindings.dampingFactor &&
      dampingFactor !== void 0
    )
      $$bindings.dampingFactor(dampingFactor);
    if (
      $$props.enableDamping === void 0 &&
      $$bindings.enableDamping &&
    ...
    if (
      $$props.enablePan === void 0 &&
      $$bindings.enablePan &&
      enablePan !== void 0
    )
      $$bindings.enablePan(enablePan);
    if (
      $$props.enableRotate === void 0 &&
      $$bindings.enableRotate &&
      enableRotate !== void 0
    )
      $$bindings.enableRotate(enableRotate);
    if (
      $$props.enableZoom === void 0 &&
      $$bindings.enableZoom &&
      enableZoom !== void 0
    )
      $$bindings.enableZoom(enableZoom);
    if (
      $$props.keyPanSpeed === void 0 &&
      $$bindings.keyPanSpeed &&
      keyPanSpeed !== void 0
    )
    ...
    if (
      $$props.maxDistance === void 0 &&
      $$bindings.maxDistance &&
      maxDistance !== void 0
    )
      $$bindings.maxDistance(maxDistance);
    if (
      $$props.maxPolarAngle === void 0 &&
      $$bindings.maxPolarAngle &&
    ...
    if (
      $$props.minDistance === void 0 &&
      $$bindings.minDistance &&
      minDistance !== void 0
    )
      $$bindings.minDistance(minDistance);
    if (
      $$props.minPolarAngle === void 0 &&
      $$bindings.minPolarAngle &&
    ...
    if (
      $$props.mouseButtons === void 0 &&
      $$bindings.mouseButtons &&
      mouseButtons !== void 0
    )
      $$bindings.mouseButtons(mouseButtons);
    if (
      $$props.panSpeed === void 0 &&
      $$bindings.panSpeed &&
      panSpeed !== void 0
    )
      $$bindings.panSpeed(panSpeed);
    if (
      $$props.rotateSpeed === void 0 &&
      $$bindings.rotateSpeed &&
      rotateSpeed !== void 0
    )
...
const Pass2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { pass } = $$props;
  const { addPass, removePass } = useThrelteRoot();
  addPass(pass);
  useFrame(() => {}, { debugFrameloopMessage: "Pass component" });
  onDestroy(() => {
    removePass(pass);
  });
  if ($$props.pass === void 0 && $$bindings.pass && pass !== void 0)
    $$bindings.pass(pass);
  return ``;
});
const InteractiveObject = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { object } = $$props;
    let previousObject = object;
    ...
    if ($$props.object === void 0 && $$bindings.object && object !== void 0)
      $$bindings.object(object);
    if (
      $$props.interactive === void 0 &&
      $$bindings.interactive &&
      interactive !== void 0
    )
      $$bindings.interactive(interactive);
    if (
      $$props.ignorePointer === void 0 &&
      $$bindings.ignorePointer &&
      ignorePointer !== void 0
    )
...
const PreprocessFallback = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    console.error(
...
var MeshoptDecoder = (function () {
  ...
  var wasmpack = new Uint8Array([
    32, 0, 65, 2, 1, 106, 34, 33, 3, 128, 11, 4, 13, 64, 6, 253, 10, 7, 15, 116,
    127, 5, 8, 12, 40, 16, 19, 54, 20, 9, 27, 255, 113, 17, 42, 67, 24, 23, 146,
    148, 18, 14, 22, 45, 70, 69, 56, 114, 101, 21, 25, 63, 75, 136, 108, 28,
    118, 29, 73, 115,
  ]);
  ...
  function decodeWorker(count, size, source, mode, filter) {
    ...
    return new Promise(function (resolve2, reject) {
      ...
      worker.object.postMessage(
        { id, count, size, source: data, mode, filter },
        [data.buffer]
      );
    });
  }
  function workerProcess(event) {
    ready.then(function () {
      ...
      try {
        ...
        self.postMessage(
          { id: data.id, count: data.count, action: "resolve", value: target },
          [target.buffer]
        );
      } catch (error) {
        self.postMessage({
...
function Pi(t2) {
  ...
  for (let t3 = 0; t3 < g2; t3++) {
    ...
    64 & e2.channelType
      ...
      : ((e2.sampleLower = _._nextUint32()),
        (e2.sampleUpper = _._nextUint32())),
      (p2.samples[t3] = e2);
  }
...
class Q {
  ...
  decode(A2, g2 = 0) {
    ...
    B.set(A2, C2),
      (g2 = g2 || Number(I.exports.ZSTD_findDecompressedSize(C2, Q2)));
...
KTX2Loader.BasisWorker = function () {
  ...
  function getTranscoderFormat(basisFormat, width, height, hasAlpha) {
    ...
    for (let i = 0; i < options.length; i++) {
      ...
      if (
        opt.needsPowerOfTwo &&
        !(isPowerOfTwo2(width) && isPowerOfTwo2(height))
      )
        continue;
  ...
  materials
    ? `${each(Object.values(materials), (material) => {
        return `${validate_component(
          DisposableObject,
          "DisposableObject"
        ).$$render($$result, { dispose, object: material }, {}, {})}`;
      })}`
    : ``
}
...
const bustRotation = writable(new Vector3(0, 0, 0));
const Bust = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $rotSpring, $$unsubscribe_rotSpring;
  let $bustRotation, $$unsubscribe_bustRotation;
  $$unsubscribe_bustRotation = subscribe(
    bustRotation,
    (value) => ($bustRotation = value)
  );
  let rot = new Vector3(0, 0, 0);
  const rotSpring = spring([0, 0, 0]);
  $$unsubscribe_rotSpring = subscribe(
    rotSpring,
    (value) => ($rotSpring = value)
  );
  {
    {
  ...
  $$unsubscribe_rotSpring();
  $$unsubscribe_bustRotation();
  return `${validate_component(Three, "Three").$$render(
    ...
    {
      default: () => {
        return `${validate_component(GLTF, "GLTF").$$render(
          $$result,
          {
...
const Scene2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="absolute w-full h-full">${validate_component(
    Canvas,
    "Canvas"
  ).$$render(
    $$result,
    ...
    {
      default: () => {
        return `${validate_component(Pass2, "Pass").$$render(
          $$result,
          { pass: new FilmPass(200, 1, 100, 0) },
          {},
          {}
        )}
    ...
    ${validate_component(Bust, "Bust").$$render($$result, {}, {}, {})}`;
      },
    }
  )}</div>`;
});
const MouseController = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    {
      {
        bustRotation.set(new Vector3(0 - $pointer.y, 0 + $pointer.x, 0));
      }
    }
    $$unsubscribe_pointer();
    return ``;
...
const UiScene = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="absolute w-full h-full">${validate_component(
    Canvas,
    "Canvas"
  ).$$render(
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1 class="m-4 text-white text-[20px] font-mono pointer-none">shot.codes</h1>
${validate_component(Scene2, "Scene").$$render($$result, {}, {}, {})}
${validate_component(UiScene, "UiScene").$$render($$result, {}, {}, {})}`;
});
